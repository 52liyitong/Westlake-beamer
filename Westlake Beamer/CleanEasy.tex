...
\begin{frame}{Introduction}
  The Weatlake Beamer based on CleanEasy Beamer theme provides a clean, professional look for academic and business presentations.
  ...
  \begin{block}{About this template}
    This presentation serves as both documentation and demonstration, showing the various elements and features available in the  theme.
  \end{block}
\end{frame}
...
\begin{frame}{Tables}
  ...
  \begin{block}{Table styling}
    The Westlake theme works well with the booktabs package for professional-looking tables. 
    Simple color alterations make tables more readable without being distracting.
  \end{block}
\end{frame}

\begin{frame}{Mathematical Equations}
  The Westlake theme includes proper mathematical typesetting:
...
\begin{frame}{Citations and References}
  Westlake works well with bibliographies and citations:
...
\begin{frame}{Theme Customization}
  The Westlake theme can be easily customized:
...
\begin{frame}{Final Thoughts}
  \begin{block}{Benefits of Westlake}
    \begin{itemize}
...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node at (current page.center) {
      \includegraphics[width=\paperwidth,height=\paperheight]{logos/picture2.jpeg}
    };
    ...
    \node[
      align=center,
      text=white,
      font=\fontsize{36pt}{42pt}\selectfont\bfseries
    ] at ([yshift=0.5cm]current page.center) {Thank you!};
  \end{tikzpicture}
  ...
  \normalsize
  \href{mailto:xun01963@gmail.com}{xun01963@gmail.com}

  \vspace{0.5cm}

  \small
  \texttt{https://github.com/52liyitong/Westlake-beamer}
\end{frame}
